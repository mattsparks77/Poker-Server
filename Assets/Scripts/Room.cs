...
public class Room : MonoBehaviour
{
    ...
    public ApplicationUser Chair7 { get; set; }
    public ApplicationUser Chair8 { get; set; }
    public ApplicationUser Chair9 { get; set; }
    ...
    public int PotOfChair7 { get; set; }
    public int PotOfChair8 { get; set; }
    public int PotOfChair9 { get; set; }
    ...
    public int getPotByIndex(int index)
    {
        switch (index)
        {
            ...
            case 5: return PotOfChair5;
            case 6: return PotOfChair6;
            case 7: return PotOfChair7;
            case 8: return PotOfChair8;
            case 9: return PotOfChair9;
            default: return -1;
        }
    }
    ...
    public void setPotByIndex(int index, int amount)
    {
        switch (index)
        {
            ...
            case 5: PotOfChair5 = amount; break;
            case 6: PotOfChair6 = amount; break;
            case 7: PotOfChair7 = amount; break;
            case 8: PotOfChair8 = amount; break;
            case 9: PotOfChair9 = amount; break;
        }
    }
    ...
    public ApplicationUser getUserByIndex(int index)
    {
        switch (index)
        {
            ...
            case 5: return Chair5;
            case 6: return Chair6;
            case 7: return Chair7;
            case 8: return Chair8;
            case 9: return Chair9;
            default: return null;
        }
    }
    ...
    public List<SidePot> CalculateMainAndSidePots()
    {
        ...
        while (getZeroPotsAmount() < numUsers - 1) // used to be 4 but i changed it
        {
